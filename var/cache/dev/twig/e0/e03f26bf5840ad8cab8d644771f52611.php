...
class __TwigTemplate_b3c88edc2f419fdc9c6ee75ca24224e8 extends Template
{
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_categorie_delete', {'id': categorie.idCategorie}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cette catégorie ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ categorie.idCategorie) }}\">
    <button class=\"btn\">Supprimer</button>
</form>", "categorie/_delete_form.html.twig", "C:\\Users\\DELL\\Desktop\\PIDEV(symfony)\\Esprit-PIDEV-Symfony-3A28-2026-FinTrust\\templates\\categorie\\_delete_form.html.twig");
    }
}
